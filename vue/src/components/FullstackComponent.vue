<template>
    <div>
        ...
        <div class="main-wrap">
            <br>
            <h1 class="cyber-h f-tektur mw-450">FULLSTACK MAP</h1>
            <DisplayComponent class="grid-bg" :is-header="true" :color="'blue'">

<!--                <div class="warning-block alert-warning">-->
<!--                    <span class="warning-block-header">warning</span>-->
<!--                    <span>Курс разбит на разделы. В каждом разделе определенное количество тем. Они(темы) отображены кубиками. 1 кубик это не 1 урок. Иногда за урок мы пройдем несколько тем, иногда несколько уроков понадобятся для освоения одной темы.</span>-->
<!--                </div>-->
                
                <div style="height: 8px"></div>
                <DefaultAlertComponent
                        :level="'warning'"
                        :message="`Курс разбит на разделы. В каждом разделе определенное количество тем. Они(темы) отображены кубиками. 1 кубик
                         это не 1 урок. Иногда за урок мы пройдем несколько тем, иногда несколько уроков понадобятся для освоения одной темы.`"
                ></DefaultAlertComponent>

                <LegendComponent></LegendComponent>
                <div v-for="(part) in fullstack" :key="part.name">
                    <br>
...
import {fullstack} from "@/components/data/dataCourseFullstack";
